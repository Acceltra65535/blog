...
Character sets for East Asian languages CJK are notoriously large, often adding megabytes of overhead to the initial page load. To eliminate this bottleneck, we re-architected our font delivery pipeline to implement dynamic sub-setting, on-demand fetching, and aggressive caching.
